...
namespace Gwen
{
    ...
    namespace Renderer
    {
        ...
        public:
            ...
            virtual void LoadFont(Gwen::Font*)    {}
            virtual void FreeFont(Gwen::Font*)    {}
        ...
        public:
            ...
            virtual bool InitializeContext(Gwen::WindowProvider*)
            {
                return false;
            }

            virtual bool ShutdownContext(Gwen::WindowProvider*)
            {
                return false;
            }

            virtual bool ResizedContext(Gwen::WindowProvider*, int, int)
            {
                return false;
            }

            virtual bool BeginContext(Gwen::WindowProvider*)
            {
                return false;
            }

            virtual bool EndContext(Gwen::WindowProvider*)
            {
                return false;
            }

            virtual bool PresentContext(Gwen::WindowProvider*)
            {
                return false;
            }
